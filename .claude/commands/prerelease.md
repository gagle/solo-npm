...
Apply the shell-safety check from `/unpublish` Phase 0.5b (canonical) to `NEXT_VERSION` and `IDENTIFIER` slots. Same metacharacter blacklist + double-quoted interpolation convention.
