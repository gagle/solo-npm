# Contributing to solo-npm-release-skill
...
[open an issue](https://github.com/gagle/solo-npm-release-skill/issues)
or start a
[discussion](https://github.com/gagle/solo-npm-release-skill/discussions);
...
1. **[Open an issue](https://github.com/gagle/solo-npm-release-skill/issues)**
   for bugs, concrete features, or specific improvements — include
   expected behavior and reproduction steps where relevant.
2. **[Open a discussion](https://github.com/gagle/solo-npm-release-skill/discussions)**
...
Open a [GitHub Discussion](https://github.com/gagle/solo-npm-release-skill/discussions)
